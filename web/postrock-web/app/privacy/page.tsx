...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Privacy practices for postrockag.com — placeholder pending legal review.",
  path: "/privacy",
});

export default async function PrivacyPage() {
  const legal = await getLegalCopy();
  const paragraphs = legal.privacyBody.split(/\n\n+/).filter(Boolean);
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 lg:px-8 lg:py-24">
      ...
      <h1 className="font-heading mt-4 text-4xl font-bold text-primary">Privacy policy</h1>
