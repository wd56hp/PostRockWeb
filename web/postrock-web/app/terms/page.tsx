...
export const metadata: Metadata = buildMetadata({
  title: "Terms of Use",
  description: "Terms governing use of postrockag.com — placeholder pending legal review.",
  path: "/terms",
});

export default async function TermsPage() {
  const legal = await getLegalCopy();
  const paragraphs = legal.termsBody.split(/\n\n+/).filter(Boolean);
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 lg:px-8 lg:py-24">
      ...
      <h1 className="font-heading mt-4 text-4xl font-bold text-primary">Terms of use</h1>
