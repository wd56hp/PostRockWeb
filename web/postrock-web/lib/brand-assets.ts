/** Logo files live in `public/images/brands/` (served at `/images/brands/...`). */
...
export const brandImages = {
  ...
  smokyHillsAgronomyLogo: "/images/brands/smoky-hills-agronomy-logo.png",
  prairieEnergyLogo: "/images/brands/prairie-energy-logo.png",
} as const;
